  ...
  return (
    <ul className="flex flex-wrap gap-x-5 gap-y-2 text-xs text-muted">
      <li className="flex items-center gap-2">
        <span aria-hidden className="size-4 rounded-sm border border-nordic-edge bg-nordic" />
        {t('completeness.legend.owned')}
      </li>
      <li className="flex items-center gap-2">
        <span aria-hidden className="size-4 rounded-sm border border-dashed border-field" />
        {t('completeness.legend.missing')}
      </li>
      <li className="flex items-center gap-2">
        <span aria-hidden className="size-4 rounded-sm bg-rule/60" />
